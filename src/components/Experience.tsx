  ...
  return (
    <section id="experience" className="py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-12">
          <h2 className="text-4xl font-bold tracking-tight text-[var(--text-primary)] mb-4">Experience</h2>
          <div className="w-16 h-1 bg-[var(--accent-1)] rounded-full" />
        </div>
        ...
        <motion.div
          ...
          className="relative border-l-2 border-[var(--glass-border)] ml-4 md:ml-0"
        >
          {/* Timeline Item */}
          <motion.div variants={itemVars} className="mb-12 ml-8 relative">
            <div className="absolute -left-[41px] top-6 w-5 h-5 rounded-full bg-[var(--accent-1)] ring-4 ring-[var(--bg-base)] shadow-lg" />
            
            <div className="liquid-glass liquid-glass-static p-8 relative overflow-visible">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-[var(--text-primary)]">Full-Stack Software Engineer</h3>
                  <h4 className="text-lg font-medium text-[var(--accent-2)] mt-1">Scaloy Technology</h4>
                  <div className="mt-2 space-y-2">
                    <p className="text-sm font-medium text-[var(--text-secondary)]">
                      <span className="text-[var(--text-primary)]">Full-Time:</span> May 2026 - Present<br/>
                      <span className="text-[var(--text-primary)]">Internship:</span> Oct 2025 - Apr 2026
                    </p>
                    <a 
                      href="/images/certificates/Internship_Certificate_Vraj.pdf" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-[var(--accent-1)] hover:text-[var(--accent-2)] transition-colors"
                    >
                ...
                <span className="mt-4 md:mt-0 liquid-glass-pill px-4 py-1.5 text-sm font-medium text-[var(--accent-1)] inline-block shrink-0 bg-[var(--chip-bg)]">
                  Present
                </span>
              </div>
              ...
              {/* Project 1 */}
              <div className="mb-6">
                <h5 className="text-lg font-bold text-[var(--text-primary)] mb-2 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[var(--accent-1)]" />
                  Inventory & Order Management System (MERN + Next.js)
                </h5>
                <ul className="list-none space-y-2 text-[var(--text-secondary)] ml-4">
                  <li className="flex gap-3">
                    <span className="text-[var(--text-muted)] mt-1 text-sm">▹</span>
